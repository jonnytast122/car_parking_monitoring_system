...
class CarEntranceCounter:
    def __init__(self, video_path, model_path, detection_region=None, counting_line_position=0.5, enable_counting=True, show_tracking=True, temporal_threshold_minutes=0.33, spatial_threshold_pixels=150, process_interval=5):
        """
    ...
    def process_video(self, output_path="output_entrance_count.mp4", display=True):
        ...
        while self.cap.isOpened():
            ...
            # imgsz=480: Image size for detection (480=FASTER, 640=better accuracy, 1280=slow but best)
            ...
            for track in tracks:
                ...
                # Store position for all tracks (needed for direction detection)
...
def main():
    ...
    # VIDEO_PATH = "output_entrance_count (trimmed).mp4"
    MODEL_PATH = "yolo12m.pt"  # Changed from yolo12x.pt - MUCH faster, still accurate
