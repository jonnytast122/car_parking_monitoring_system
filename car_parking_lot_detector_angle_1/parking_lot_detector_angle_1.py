...
def main():
    # Configuration
    IMAGE_PATH = "20251224123554781_frame_0.jpg"  # Change this to your input image path
    MODEL_PATH = "yolov12x.pt"  # Use yolo11x.pt or yolo8x.pt for better small object detection
    PARKING_SPOTS_JSON = "20251224123554781_frame_0.json"
    OUTPUT_PATH = "jonny_parking_lot_output.jpg"
    ...
    detector = ParkingLotDetector(
        ...
        conf_threshold=0.2,        # Lower confidence for dark/shadowed areas (0.2 for trees/shadows)
        iou_threshold=0.4,         # Lower IoU for small objects (0.4 recommended)
        ...
        imgsz=1920,                # Higher resolution for small objects and shadowed areas (1920 for best detection)
        # Image enhancement for dark/shadowed areas (like cars under trees)
